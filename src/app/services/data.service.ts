...
export class DataService {
  ...
  private data = {
    "restaurant_info": {
       ...
       "description": "Es un chef, dueÒo de restaurantes y presentador de televisiÛn brit·nico. En toda su carrera gastronÛmica ha sido condecorado con 17 estrellas Michelin, de las que hoy mantiene. Adem·s de sus facetas culinarias, Ramsay es conocido por presentar programas de televisiÛn y espacios de telerrealidad sobre cocina, tanto en Reino Unido como en Estados Unidos."
    },
    "recipes": [
       {
          ...
          "step": [
             {
                "description": "Cut the bacon into lardons and sautÈ until it's lightly cooked."
             },
             {
          ...
          "ingredientGroup": [
             {
                ...
                "ingredient": [
                   ...
                   },
                   {
                      "amount": "500",
                      "unit": "g",
                      "name": "passata (Italian-style sieved tomato purÈe)"
                   },
                   {
                      "name": "cinammon",
                      "preparation": "ground"
             ...
             },
             {
                ...
                "ingredient": [
                   ...
                   },
                   {
                      "amount": "250",
                      "unit": "g",
                      "name": "hard cheese (we used GruyËre)",
                      "preparation": "grated"
                   },
                   {
                      "name": "nutmeg",
       ...
       },
       {
          ...
          "step": [
             ...
             {
                "description": "Reduce heat a little, add jalapeÒo and bell pepper, cook until slightly soft. 3-4 min, do not overcook"
             },
             {
       ...
       },
       {
          ...
          "image": "https://www.seriouseats.com/recipes/images/2016/04/20131009-caesar-salad-food-lab-11-Edit.jpg",
          "ingredient": [
             {
                "amount": "0.5",
                "unit": "Head",
       ...
       },
       {
          ...
          "step": [
             ...
             {
                "description": "Stir then microwave on HIGH for another minute. Repeat until it's soft, usually doesnít need more than 2 minutes total."
             },
             {
             ...
             {
                "description": "If you can manage to flip the pizza over without breaking it, flip it and bake a bit longer to make it crispy. If youíre worried it will break don't flip it, we never do and itís fine!"
             },
             {
             ...
             {
                "description": "While the base is baking and the sauce simmering, cut the bacon into 5mm lardons and sautÈ with the mushrooms until almost (but not completely) cooked to your liking."
             },
             {
       ...
       },
       {
          ...
          "name": "Garlic mushrooms a la crËme with lardons and green pepper",
       ...
       },
       {
          ...
          "step": [
             ...
             {
                "description": "SautÈ garlic and onion in a bit of butter."
             },
             {
                "description": "Add the livers and sautÈ on both sides until they have a bit color but are still pink inside. Season with salt and pepper."
             },
             {
       ...
       },
       {
          ...
          "step": [
             ...
             {
                "description": "Place the salmon fillets in separate zip lock bags and pour the remaining sauce into the bags, dividing evenly. If you have time you can let them marinate for 1-4 hours, but you donít have to."
             },
             {
                "description": "Prepare a sous vide immersion circulator for use according to the manufacturerís instructions. Preheat the water to 122∞F (50∞C). Place the bags into the circulating water and cook for 40 minutes for medium doneness."
             },
             {
       ...
       },
       {
          ...
          "ingredientGroup": [],
          "notes": "- Graviera is a Greek hard light yellow cheese. Canít find graviera? Use any yellow cheese that melts. The sfouggato in this photo was actually made with cheddar!\n- Donít have all the ingredients? Worry not! This is a dish with many variations. Most of the ingredients are optional. What is absolutely mandatory is the eggs, zucchinis, some herbs (parsley, dill, and/or mint), some kind of cheese, and some kind of onion (only red onion or only spring onion is ok).",
       ...
       },
       {
          ...
          "step": [
             {
                "description": "Wash the mint and parsley and make sure they are completely dry. A salad spinner helps, if you donít have one you can use paper towels."
             },
             {
                "description": "Finely chop the mint and parsley, then sautÈ until just starting to turn crispy. Set aside."
             },
             {
                "description": "SautÈ the onion with enough butter or oil until golden"
             },
             {
                "description": "Add the garlic and sautÈ for 1-2 more minutes"
             },
             {
                "description": "Add the turmeric and sautÈ for 2 more minutes"
             },
             {
                "description": "Add the beef cubes and sautÈ until browned on the outside"
             },
             {
                "description": "Pour in the beef stock and sautÈed mint and parsley and simmer"
             },
             {
                "description": "In a separate pan, sautÈ the celery until just starting to turn brown. Set aside."
             },
             {
                "description": "After the stew has been simmering for 1.5 hour, pour in the sautÈed celery and simmer for another 30 minutes. This is done so that the celery doesnít become too mushy."
             },
             {
                "description": "Finish with the lemon juice and serve."
             }
          ],
          "image": "https://fae-magazine.com/wp-content/uploads/2015/07/Khoresh-Karafs-2.jpg",
          "tag": [
             "Stew",
             "Persian",
             "Beef"
  ...
  getRecipes(){
    for(let i = 0; i < 15; i++){
      this.recipes[i] = this.data.recipes[i];
    }
    return this.recipes;
   }
   ...
   getOneRecipe(id: string){
      for(let i = 0; i < 15; i++){
         if(this.data.recipes[i].id == id){
            this.recipe = this.data.recipes[i];
            i = 15;
         }
       }
       return this.recipe;
   ...
   getRestInfo(){
     return this.restInf = this.data.restaurant_info;
   }
